...
@testitem "getrowend" begin
    import TextParse: getrowend, LocalOpts
...
@testitem "Float parsing" begin
    import TextParse: tryparsenext, unwrap, fromtype, Percentage
    using Random
    using Nullables
...
@testitem "Int parsing" begin
    import TextParse: tryparsenext, unwrap, failedat, fromtype
...
@testitem "String parsing" begin
    import TextParse: tryparsenext, unwrap, LocalOpts, StringToken, Quoted
...
@testitem "Quoted string parsing" begin
    import TextParse: tryparsenext, unwrap, failedat, LocalOpts, StringToken, Quoted, NAToken, Unknown, fromtype, Percentage
...
@testitem "NA parsing" begin
    import TextParse: tryparsenext, unwrap, failedat, NAToken, fromtype
...
@testitem "Field parsing" begin
    import TextParse: tryparsenext, unwrap, LocalOpts, Field, fromtype
...
@testitem "Record parsing" begin
    import TextParse: tryparsenext, unwrap, failedat, Field, fromtype, Record
...
@testitem "UseOne" begin
    import TextParse: tryparsenext, unwrap, Field, fromtype, UseOne
...
@testitem "Repeated" begin
    import TextParse: tryparsenext, unwrap, Field, fromtype, Repeated
...
@testitem "quotedsplit" begin
    import TextParse: quotedsplit, LocalOpts
...
@testitem "CSV column names" begin
...
@testitem "guesstoken" setup=[TokenCompare] begin
    import TextParse: guesstoken, Unknown, Numeric, DateTimeToken, StrRange, LocalOpts, NAToken, Percentage, Quoted, StringToken
    using Dates
...
@testitem "CSV type detect" setup=[TokenCompare] begin
    import TextParse: guesscolparsers, readcolnames, LocalOpts, Quoted, StringToken, StrRange, fromtype, NAToken
    using WeakRefStrings
...
@testitem "date detection" begin
    import TextParse: guessdateformat, DateTimeToken
    using Dates
...
@testitem "date parsing" begin
    import TextParse: tryparsenext, unwrap, failedat, DateTimeToken, LocalOpts
    using Dates
...
@testitem "csvread" begin
    ...
    @test isequal(csvread([joinpath(@__DIR__, "data", "a.csv"), joinpath(@__DIR__, "data", "b.csv")]),
                  (([1.0, 2.0, 1.0, 2.0, 3.0], [2, 2, missing, missing, missing],
                    [missing, missing, missing, 2, 1]), String["x", "y", "z"], [2, 3]))
    @test isequal(csvread([joinpath(@__DIR__, "data", "a.csv"), joinpath(@__DIR__, "data", "b.csv")], samecols=[("y","z")]),
...
@testitem "skiplines_begin" begin
    import TextParse: _csvread
...
@testitem "custom parser" begin
    import TextParse: tryparsenext, unwrap, failedat, Numeric, eatwhitespaces
    using Nullables
...
@testitem "read gzipped files" begin
