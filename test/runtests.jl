...
@testset "TextParse" begin
    ...
    @testset "Float parsing" begin
        ...
        @test tryparsenext(Percentage(), "33%") |> unwrap == (0.33, 4)
        @test tryparsenext(Percentage(), "3.3%") |> unwrap == (0.033, 5)
        ...
        @test tryparsenext(Percentage(), SubString("33%", 1)) |> unwrap == (0.33, 4)
        @test tryparsenext(Percentage(), SubString("3.3%", 1)) |> unwrap == (0.033, 5)
